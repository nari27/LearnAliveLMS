          ...
          <main style={{ minHeight: '80vh' }}>
            <Routes>
              ...
              <Route
                ...
                element={<FinalRegistrationPage />}
              />
              <Route path="/" element={<Dashboard />} />
              <Route
                path="/admin/university"
                element={<AdminUniversityDepartmentManagement />}
              />
              ...
              />
              <Route
                path="/classroom/:classId/boards/addpost/:boardId"
                element={<AddPostPage />}
              />{' '}
              {/* 게시글 추가 페이지 */}
              ...
              <Route path="/mypage" element={<MyPage />}>
                ...
                <Route
                  path="/mypage/achievements/detail"
