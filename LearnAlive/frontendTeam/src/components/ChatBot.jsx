...
import { fetchAllChatBots, searchChatBot } from '../api/chatbotApi';
    ...
    <div className="chatbot-wrapper">
      <div className="chatbot-container">
        ...
        <div className="keyword-box">
          ...
          <span
            className="keyword"
            onClick={() => handleKeywordClick('로그인')}
          >
            로그인
          </span>
          <span
            className="keyword"
            onClick={() => handleKeywordClick('강의실')}
          >
            강의실
          </span>
          <span
            className="keyword"
            onClick={() => handleKeywordClick('게시판')}
          >
            게시판
          </span>
          ...
          <span
            className="keyword"
            onClick={() => handleKeywordClick('캘린더')}
          >
            캘린더
          </span>
          <span
            className="keyword"
            onClick={() => handleKeywordClick('메시지')}
          >
            메시지
          </span>
        </div>
