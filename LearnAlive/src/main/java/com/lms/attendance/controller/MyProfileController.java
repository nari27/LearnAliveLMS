...
public class MyProfileController {
    ...
    public ResponseEntity<MyPage> getUser(@PathVariable("userId") String userId,
    ...
    public ResponseEntity<List<String>> getClassByClassId(@PathVariable("classId") String classId) {
